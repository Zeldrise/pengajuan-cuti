  ...
  return (
    <main className="justify-center items-center">
      ...
      <div className="flex flex-col md:flex-row-reverse justify-around mx-auto w-11/12 md:w-9/12 bg-yellow-50 rounded-2xl shadow-xl shadow-yellow-500/50">
        <div className="bg-yellow-50 border-solid border-0 md:border-2 border-yellow-500 rounded-xl my-5 justify-center items-center md:w-[400px] w-full shadow-xl shadow-black-500/50">
          <div className={`${inter.className}  p-5`}>
            ...
            <form>
              ...
              <div>
                <button
                  type="submit"
                  className="w-full text-center text-white font-bold  bg-yellow-400  focus:ring-4 focus:outline-none focus:ring-yellow-300 shadow-lg shadow-yellow-500/50 rounded-lg  px-5 py-2.5 mt-[125px]"
                >
                  Login
                </button>
              </div>
