    ...
    <main className="w-full bg-yellow-50 justify-center items-center rounded-2xl shadow-xl shadow-yellow-500/50">
      ...
      <form>
        ...
        >
          <div className="p-2 flex flex-col ">
            ...
            <div className="flex flex-row gap-2 justify-around">
              <label>
                <input type="radio" name="tipe_cuti" value="personal" />
                Personal
              </label>
              <label>
                <input type="radio" name="tipe_cuti" value="keluarga" />
                Keluarga
              </label>
              <label>
                <input type="radio" name="tipe_cuti" value="sakit" />
                Sakit
              </label>
            </div>
          </div>
        ...
        >
          ...
          <button
            type="submit"
            className="text-gray-900 bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-yellow-300 shadow-lg shadow-yellow-500/50 rounded-lg text-sm px-5 py-2.5 text-center my-5 mx-3"
          >
            Submit
          </button>
        </div>
